window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region src/client/audio-encoder.ts
		/**
		...
		* @module dsh-client-ui-voice-input/client/audio-encoder
		*/
		...
		*/
		function VoiceInputControl({ input, transcribe, appendDraft, t }) {
			...
			const finish = (0, react.useCallback)(() => {
				...
				recording.stop().then(async (outcome) => {
					...
					if (outcome.audioBase64.length > MAX_AUDIO_BASE64_LENGTH$1) {
						setPhase("idle");
						setError(t("tooLarge"));
						return;
					}
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MicGlyph, { recording: phase === "recording" })
		...
		function MicGlyph({ recording }) {
			if (recording) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				width: "14",
				height: "14",
				viewBox: "0 0 14 14",
				"aria-hidden": true,
		...
		*/
		async function transcribeOverHttp(audioBase64, format = "wav") {
			if (audioBase64.length > 10485760) return { error: `audio is too long (${audioBase64.length} > ${MAX_AUDIO_BASE64_LENGTH})` };
			let response;
			try {
		...
		*/
		function apply(ctx) {
			...
			ctx.slots.inject("conversation.input.left", () => ctx.slots.register({
				...
				locale: NS,
				inject: (sessionId) => ({
					transcribe: async (audioBase64) => transcribeOverHttp(audioBase64),
					appendDraft: (text) => {
